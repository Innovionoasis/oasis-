...
import { loginWithGoogle, loginWithFacebook } from '../auth.services';
...
const SocialLogin = ({ onSuccess, onError }) => {
  ...
  const handleAppleLogin = () => {
    onError && onError({ message: "تسجيل الدخول باستخدام Apple غير متاح حاليًا" });
  };

  return (
    <div className="social-account-container">
      <span className="title">أو تسجيل الدخول باستخدام</span>
