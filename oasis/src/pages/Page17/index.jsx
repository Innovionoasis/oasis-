...
export default function Page17Page() {
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden w-full">
              ...
              <div className="pt-12 px-6">
                <div className="flex justify-between items-center">
                  <div>
                    <Heading size="heading3xl" as="h2" className="font-bold">Sarah</Heading>
                    <Heading size="heading5xl" as="h4" className="text-gray-500">مستثمر</Heading>
                  </div>
                ...
                <div className="mt-4 relative">
                  <div className="flex items-center justify-between mb-2">
                    <Heading size="heading5xl" as="h5" className="text-[16px] font-bold">نبذة عني:</Heading>
                    {!isEditingBio && (
                      <div className="flex items-center gap-2">
                ...
                <div className="flex items-start justify-between mt-6">
                  <div className="flex w-[25%] flex-col gap-2">
                    <Heading size="heading5xl" as="h1" className="text-[16px] font-bold">المشاريع تم تمويلها</Heading>
                    <div
                  ...
                  <div className="grid grid-cols-2 gap-4 w-[70%]">
                    <EditableBox title="المجالات و الاهتمامات " items={projects} setItems={setProjects} iconSrc="images/img_flipboard.png" />
                    <EditableBox title=" الشبكات والشراكات" items={skills} setItems={setSkills} iconSrc="images/img_resume.png" />
                    <EditableBox title="خطط النمو " items={experiences} setItems={setExperiences} iconSrc="images/img_front_desk.png" />
                    <EditableBox title="الانجازات" items={certificates} setItems={setCertificates} iconSrc="images/img_internship.png" />
                  </div>
                </div>
